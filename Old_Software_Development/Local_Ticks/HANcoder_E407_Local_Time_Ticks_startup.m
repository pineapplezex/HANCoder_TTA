...
simulation_time = Simulink.Signal;
simulation_time.StorageClass = 'ExportedGlobal';
clock_state = Simulink.Signal;
clock_state.StorageClass = 'ExportedGlobal';
global_ticks = Simulink.Signal;
global_ticks.StorageClass = 'ExportedGlobal';
