...
LA_COMM_dly = 0; % Toggle DO for COMM delay measurement [CAN1:Tx D13,Rx D12, CAN2:Tx D9,Rx D8]
LA_E_Desync = 0; % Toggle DO right before resync at LT_Update [D10]
...
comm_delay_measured2 = 0.0003; % [0.3 ms]
...
comm_delay_estimation2 = ...
    round(comm_delay_measured2*hardware_granularity/frequency_IRQ); % [0.3 ms] in ticks
