...
MODEL                = HANcoder_E407_TTA_Controller_v3
MODULES              = HANcoder_E407_TTA_Controller_v3_data.c
MAKEFILE             = HANcoder_E407_TTA_Controller_v3.mk
...
#|---------------------------------------------------------------------------------------
MODELLIB                  = HANcoder_E407_TTA_Controller_v3lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I"C:\Users\Diego\Desktop\HAN\MAJORP~1\MP_Code\TTA_CO~1\HANCOD~1.0\Target\HANcoder_E407_TTA_Controller_v3_ert_rtw" \
	-I"$(MATLAB_ROOT)\extern\include" \
	-I"$(MATLAB_ROOT)\simulink\include" \
	-I"$(MATLAB_ROOT)\rtw\c\src" \
