...
MODEL                = HANcoder_E407_GTSync
MODULES              = HANcoder_E407_GTSync_data.c
MAKEFILE             = HANcoder_E407_GTSync.mk
...
#|---------------------------------------------------------------------------------------
MODELLIB                  = HANcoder_E407_GTSynclib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
# Additional includes
ADD_INCLUDES = \
	-I"D:\Jamie\Documents\School\MDS\project\Target" \
	-I"D:\Jamie\Documents\School\MDS\project\Target\HANcoder_E407_GTSync_ert_rtw" \
	-I"$(MATLAB_ROOT)\extern\include" \
	-I"$(MATLAB_ROOT)\simulink\include" \
	-I"$(MATLAB_ROOT)\rtw\c\src" \
...
LINKER_LNK   = -T "$(CFG_PATH)\stm32_e407_jtag.x"
endif
...
#|---------------------------------------------------------------------------------------
HANcoder_LIB_SRCS = \
  anin.c anout.c app.c croutine.c errorHandling.c heap_4.c list.c os.c \
  queue.c tasks.c eeprom.c eeprom_sim.c \
  ...
  ff.c unicode.c timein.c uart.c spi_master.c filelogger.c mmc.c ftoa.c usbd_cdc_core.c \
